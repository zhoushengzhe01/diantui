    ...
    <div class="content">
        <div class="title-box">
            ...
            <div class="search-box">
                <el-form :inline="true" :model="paramete" class="demo-form-inline" size="mini">
                    ...
                    <el-form-item>
                        <el-button type="success" @click="getCategorys">查询</el-button>
                        <el-button type="success" @click="getCategory('')">添加分类</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        ...
        <el-dialog title="添加/编辑" :visible.sync="show" class="small_dialog">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="success" @click="postCategory(category)">确 定</el-button>
            </div>
        </el-dialog>
...
export default {
    ...
    methods:{
        getCategorys: function()
        {
            ...
            Th.$api.get('admin/advertiser/ad/categorys.json', Th.paramete, function(data)
            {
                Th.data = data;    
                Th.loading = false;
        ...
        postCategory: function(row)
        {
            ...
            if(row.id){
                Th.$api.put('admin/advertiser/ad/category/'+row.id+'.json', row, function(data)
                {
            ...
            {
                Th.$api.post('admin/advertiser/ad/category.json', row, function(data)
                {
