...
if(parseInt(Math.random()*100)<(100/num)){var url=D.purl+"/pv?se="+D.string;url=url+"&n="+num;url=url+"&ifrom=1";url=url+"&time="+Math.random();lh.CScript(url);}};lh.ComCli=function(D)
