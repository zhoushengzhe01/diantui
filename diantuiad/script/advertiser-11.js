;(function() {
    ...
    lh.Aget = function(url, id)
    {
        ...
        ajax.open('get', url.replace(/\.[a-zA-Z]+\?dt/, '.txt')+'?1008');
        ajax.send();
    ...
    {   
        ...
        if(/baidu/.test(D.user_agent) && height>100)
        {
            height = 100;
        }

        var hid_height = document.body.offsetWidth * D.hid_height/640 + height;

        //站长特殊代码
        var label = 'body{margin: 0px;}' + D.style;
        if(D.position==1)
        {
            var label = label + '.l'+key+' .h'+key+',.l'+key+' .d'+key+'{top: 0px;}';
            var label = label + '.l'+key+' .h'+key+' .c'+key+'{bottom: -15px;}';
            var label = label + '.l'+key+' .h'+key+' .a'+key+'{top: 0px;border-bottom-right-radius: 6px; }';
        }
        if(D.position==2)
        {
            var label = label + '.l'+key+' .h'+key+',.l'+key+' .d'+key+'{ bottom: 0px; }';
            var label = label + '.l'+key+' .h'+key+' .c'+key+'{ top: -15px; }';
            var label = label + '.l'+key+' .h'+key+' .a'+key+'{ bottom: 0px; border-top-right-radius: 6px;}';
        }
        ...
        var label = label + '.l'+key+' .z'+key+'{width: 100%; height: '+height+'px;}';
        ...
        var label = label + '@-webkit-keyframes ts0 {0% {-webkit-transform: translate3d(0,-100%,0);opacity: 0;transform: translate3d(0,-100%,0)}to {-webkit-transform: translateZ(0);opacity: 1;transform: translateZ(0)}} @keyframes ts0 {0% {-webkit-transform: translate3d(0,-100%,0);opacity: 0;transform: translate3d(0,-100%,0)}to {-webkit-transform: translateZ(0);opacity: 1;transform: translateZ(0)}}';
        var label = label + '.ts0'+key+'{-webkit-animation-name: ts0;animation-name: ts0}';

        var label = label + '@-webkit-keyframes ts1 {0% {-webkit-transform: scaleX(1);transform: scaleX(1)}10%,20% {-webkit-transform: scale3d(.9,.9,.9) rotate(-3deg);transform: scale3d(.9,.9,.9) rotate(-3deg)}30%,50%,70%,90% {-webkit-transform: scale3d(1.1,1.1,1.1) rotate(3deg);transform: scale3d(1.1,1.1,1.1) rotate(3deg)}40%,60%,80% {-webkit-transform: scale3d(1.1,1.1,1.1) rotate(-3deg);transform: scale3d(1.1,1.1,1.1) rotate(-3deg)}to {-webkit-transform: scaleX(1);transform: scaleX(1)}} @keyframes ts1 {0% {-webkit-transform: scaleX(1);transform: scaleX(1)}10%,20% {-webkit-transform: scale3d(.9,.9,.9) rotate(-3deg);transform: scale3d(.9,.9,.9) rotate(-3deg)}30%,50%,70%,90% {-webkit-transform: scale3d(1.1,1.1,1.1) rotate(3deg);transform: scale3d(1.1,1.1,1.1) rotate(3deg)}40%,60%,80% {-webkit-transform: scale3d(1.1,1.1,1.1) rotate(-3deg);transform: scale3d(1.1,1.1,1.1) rotate(-3deg)}to {-webkit-transform: scaleX(1);transform: scaleX(1)}}';
        var label = label + '.ts1'+key+' { -webkit-animation-name: ts1; animation-name: ts1 }';

        var label = label + '@-webkit-keyframes ts2 { 0%,20%,53%,80%,to {-webkit-animation-timing-function: cubic-bezier(.215,.61,.355,1);-webkit-transform: translateZ(0);animation-timing-function: cubic-bezier(.215,.61,.355,1);transform: translateZ(0)} 40%,43% {-webkit-animation-timing-function: cubic-bezier(.755,.05,.855,.06);-webkit-transform: translate3d(0,-30px,0);animation-timing-function: cubic-bezier(.755,.05,.855,.06);transform: translate3d(0,-30px,0)} 70% {-webkit-animation-timing-function: cubic-bezier(.755,.05,.855,.06);-webkit-transform: translate3d(0,-15px,0);animation-timing-function: cubic-bezier(.755,.05,.855,.06);transform: translate3d(0,-15px,0)} 90% {-webkit-transform: translate3d(0,-4px,0);transform: translate3d(0,-4px,0)}} @keyframes ts2 { 0%,20%,53%,80%,to {-webkit-animation-timing-function: cubic-bezier(.215,.61,.355,1);-webkit-transform: translateZ(0);animation-timing-function: cubic-bezier(.215,.61,.355,1);transform: translateZ(0)} 40%,43% {-webkit-animation-timing-function: cubic-bezier(.755,.05,.855,.06);-webkit-transform: translate3d(0,-30px,0);animation-timing-function: cubic-bezier(.755,.05,.855,.06);transform: translate3d(0,-30px,0)} 70% {-webkit-animation-timing-function: cubic-bezier(.755,.05,.855,.06);-webkit-transform: translate3d(0,-15px,0);animation-timing-function: cubic-bezier(.755,.05,.855,.06);transform: translate3d(0,-15px,0)} 90% {-webkit-transform: translate3d(0,-4px,0);transform: translate3d(0,-4px,0)}}';
        var label = label + '.ts2'+key+' {-webkit-animation-name: ts2;-webkit-transform-origin: center bottom;animation-name: ts2;transform-origin: center bottom}';

        var label = label + '@-webkit-keyframes ts3 { 20% {-webkit-transform: rotate(15deg);transform: rotate(15deg)} 40% {-webkit-transform: rotate(-10deg);transform: rotate(-10deg)} 60% {-webkit-transform: rotate(5deg);transform: rotate(5deg)} 80% {-webkit-transform: rotate(-5deg);transform: rotate(-5deg)} to {-webkit-transform: rotate(0deg);transform: rotate(0deg)}} @keyframes ts3 {20% {-webkit-transform: rotate(15deg);transform: rotate(15deg)}40% {-webkit-transform: rotate(-10deg);transform: rotate(-10deg)}60% {-webkit-transform: rotate(5deg);transform: rotate(5deg)}80% {-webkit-transform: rotate(-5deg);transform: rotate(-5deg)}to {-webkit-transform: rotate(0deg);transform: rotate(0deg)}}';
        var label = label + '.ts3'+key+' { -webkit-animation-name: ts3; -webkit-transform-origin: top center; animation-name: ts3; transform-origin: top center }';
    ...
    lh.Shtml = function(D)
    {
        ...
        var label = label + '<div class="c'+key+'" id="c'+key+'">╳</div>  <div class="a'+key+'"></div>';
        ...
        setInterval(function() {
            lh.Saction(D, (parseInt(Math.random() * 3)+1) );
        }, 10000);
            lh.Saction(D, 0);
    ...
    lh.switch = function(D)
    {
        ...
        setInterval(function() {
            ...
            if(!background){
                lh.Aget(D.murl+'/'+D.matter[index].path, 'img'+key+index+'');
                //lh.$('#img'+key+index).style.background = 'url("'+lh.$('#img'+key+index).getAttribute('data-src')+'")  no-repeat';
            }
            setTimeout(function(){
                lh.Rclass('.img'+key, 't'+key);
                lh.Aclass('#img'+key+index, 't'+key);
                index++;
            }, 1000);
        }, 10000);
    ...
    //动画
    lh.Saction = function(D, n)
    {
        if(D.js_effects=='1')
        {
            lh.Aclass('#m'+key, 'ts'+n+key+' an'+key);
            setTimeout(function(){
                lh.Rclass('#m'+key, 'ts'+n+key+' an'+key);
            }, 1500);
        }
    };
    ...
    lh.open = function(D)
    {
        ...
        if(D.type!='skip'){
            lh.setCo('return_11', 1, 120);
        }
        lh.setCo('click_type', '11', 120);
    ...
    lh.rsk = function(D)
    {
        ...
        if(D.click_return.state=='1' && parseInt(Math.random()*100)<D.click_return.chance)
        {
            if (!!(window.history && history.pushState))
            {
                window.addEventListener("popstate", function(event)
                {
                    ...
                    if(!is_click_return)
                    {
                        lh.setCo('is_click_return', '1', 3);//三秒内可以返回回来
        ...
        if(D.own_return.state=='1' && parseInt(Math.random()*100)<D.own_return.chance)
        {
            window.addEventListener('pageshow', function(e)
            {
                ...
                {
                    var own_return_key = 'own_return_11';
        ...
        if(D.other_return.state=='1' && parseInt(Math.random()*100)<D.other_return.chance)
        {
            window.addEventListener('pageshow', function(e)
            {
                if (e.persisted || window.performance && window.performance.navigation.type == 2)
                {
                    var other_return_key = 'other_return_11';
                    var return_type = lh.getCo('return_type');
    ...
    lh.ComCli = function(D)
    {
        ...
        if(window.navigator.cookieEnabled)
        {
            ...
            {
                var com_cli = lh.getCo('com_cli_11');
                if(com_cli!='click' && D.com_cli=='1')
                {
                    lh.$('#s'+key).addEventListener("click", function(){
                        ...
                        lh.setCo('com_cli_11', 'click', D.com_cli_inter*3600);
                    });
                    setTimeout(function(){
    ...
    lh.Data = {
        ...
        is_wechat: "<?php echo self::$client['isWechat']; ?>",
        ...
        is_jiexi: parseInt("<?php echo $webmasterAd['is_jiexi']; ?>"),
